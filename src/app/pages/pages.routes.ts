...
import { SignosSearchComponent } from './signos/signos-search/signos-search.component';
...
export const pagesRoutes: Routes = [
  ...
  { path: 'signos', component: SignosComponent, canActivate: [certGuard]  },
  { path: 'signos-search', 
    component: SignosSearchComponent, 
    children: [
